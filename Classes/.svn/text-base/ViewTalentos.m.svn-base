...
- (void)viewDidLoad {
	...
	[self.view addSubview:tabNavegacao];
	scrollview.contentSize = CGSizeMake(320, 2650);
	[self.view addSubview:[functions headerTableview:@"Talentos" subTitle:@"A GS&MD quer contar com seu talento!"]];
